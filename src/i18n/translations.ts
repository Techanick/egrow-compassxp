export type Language = 'en' | 'fr' | 'es' | 'tr' | 'zh' | 'it';
...
const translations: Record<Language, TranslationKeys> = {
  ...
  it: {
    dashboard: 'Cruscotto',
    frameworkExplorer: 'Esplora Framework',
    selfAssessment: 'Autovalutazione',
    developmentPlan: 'Piano di Sviluppo',
    team: 'Team',
    logout: 'Esci',
    login: 'Accedi',
    welcome: 'Benvenuto',
    ...
    browseFramework: 'Esplora il framework',
    progressSummary: 'Riepilogo progressi',
    roles: 'Ruoli',
    skills: 'Competenze',
    behaviors: 'Comportamenti',
    masteryLevels: 'Livelli di padronanza',
    fundamentals: 'Fondamentali',
    intermediate: 'Intermedio',
    advanced: 'Avanzato',
    referent: 'Referente / Modello',
    ...
    assessmentHistory: 'Storico valutazioni',
    assessmentIntro: 'Valuta la frequenza con cui dimostri ciascun comportamento. I tuoi livelli di padronanza saranno calcolati automaticamente.',
    skillProgress: 'Competenza',
    rateEachBehavior: 'Valuta ciascun comportamento qui sotto',
    levelValidated: 'Livello convalidato',
    levelNotValidated: 'Non ancora convalidato',
    validationRule: 'Un livello è convalidato quando almeno 3 comportamenti sono valutati "Spesso" o "Quasi sempre"',
    assessmentResults: 'Risultati della valutazione',
    yourMasteryLevels: 'I tuoi livelli di padronanza',
    validatedLevel: 'Convalidato',
    notYetValidated: 'Non convalidato',
    restartAssessment: 'Nuova valutazione',
    behaviorRated: 'comportamenti valutati',
    of: 'di',
    recommendedSkills: 'Competenze raccomandate',
    targetLevel: 'Livello obiettivo',
    addAction: 'Aggiungi azione',
    actionPlan: 'Piano d\'azione',
    inProgress: 'In corso',
    completed: 'Completato',
    selectSkillsToFocus: 'Seleziona le competenze su cui concentrarti',
    gapAnalysis: 'Analisi dei gap',
    currentLevel: 'Livello attuale',
    noAssessmentYet: 'Nessuna valutazione ancora',
    completeAssessmentFirst: 'Completa prima un\'autovalutazione per identificare le lacune e costruire un piano di sviluppo mirato.',
    goToAssessment: 'Vai all\'autovalutazione',
    addActionItem: 'Aggiungi azione',
    actionDescription: 'Descrivi l\'azione...',
    deadline: 'Scadenza',
    markComplete: 'Segna come completato',
    markInProgress: 'Segna come in corso',
    removeAction: 'Rimuovi',
    noActionsYet: 'Nessuna azione ancora',
    addFirstAction: 'Aggiungi la tua prima azione',
    progressOverview: 'Progresso complessivo',
    focusSkills: 'Competenze prioritarie',
    selectUpTo: 'Seleziona fino a 2 competenze da sviluppare in base alle tue lacune.',
    buildPlan: 'Crea piano',
    editSelection: 'Modifica selezione',
    todo: 'Da fare',
    suggestedTools: 'Strumenti di sviluppo suggeriti',
    behaviorToWorkOn: 'Comportamenti su cui lavorare',
    teamOverview: 'Panoramica del team',
    directReports: 'Collaboratori diretti',
    lastAssessment: 'Ultima valutazione',
    highestLevel: 'Livello più alto',
    focusAreas: 'Aree prioritarie',
    actionsProgress: 'Progresso azioni',
    noAssessment: 'Nessuna valutazione',
    viewAssessment: 'Vedi valutazione',
    viewPlan: 'Vedi piano',
    teamSkillOverview: 'Panoramica competenze del team',
    averageLevel: 'Livello medio',
    teamMember: 'Membro del team',
    assessmentDate: 'Data valutazione',
    developmentStatus: 'Stato di sviluppo',
    onTrack: 'In linea',
    needsAttention: 'Richiede attenzione',
    notStarted: 'Non iniziato',
    teamInsights: 'Approfondimenti del team',
    strongestSkill: 'Competenza più forte',
    developmentNeeded: 'Sviluppo necessario',
    save: 'Salva',
    cancel: 'Annulla',
    back: 'Indietro',
    next: 'Avanti',
